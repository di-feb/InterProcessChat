...
struct vector{
	Pointer* array; 			// Πίνακας με τα δεδομενα που υπόστηριζει ο Vector.
	int size;					// Ο αριθμος των στοιχειων που υπαρχουν στον πινακα.
	int capacity;				// Το μεγεθος του πινακα.
